...
public class AnimationTestStart extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Rectangle rectangle2 = new Rectangle(50, 120, 50, 50);
        rectangle2.setFill(Color.GREEN);

        Rectangle rectangle3 = new Rectangle(50, 170, 50, 50);
        rectangle3.setFill(Color.GREENYELLOW);

        Rectangle rectangle4 = new Rectangle(50, 220, 50, 50);
        rectangle4.setFill(Color.YELLOW);

        Rectangle rectangle5 = new Rectangle(50, 270, 50, 50);
        rectangle5.setFill(Color.DARKGRAY);

        Rectangle rectangle6 = new Rectangle(50, 320, 50, 50);
        rectangle6.setFill(Color.BLUE);

        Rectangle rectangle7 = new Rectangle(50, 370, 50, 50);
        rectangle7.setFill(Color.BLACK);

        Rectangle rectangle8 = new Rectangle(50, 420, 50, 50);
        rectangle8.setFill(Color.BLUEVIOLET);

        Rectangle rectangle9 = new Rectangle(50, 470, 50, 50);
        rectangle9.setFill(Color.BROWN);

        Rectangle rectangle10 = new Rectangle(50, 520, 50, 50);
        rectangle10.setFill(Color.LAVENDER);

        Rectangle rectangle11 = new Rectangle(50, 570, 50, 50);
        rectangle11.setFill(Color.AZURE);

        Rectangle rectangle12 = new Rectangle(50, 620, 50, 50);
        ...
        new Thread( () -> {
            ...
            for (int i = 0; i < allYearsList.size(); i++) {
                for (int monthCounter = 11; monthCounter >= 0; monthCounter--) {
                    ...
                    System.out.println("Year = " + year + " Population  = " + population + " Counter = " + counter + " Bar Ratio = " + getBarRatio(Integer.parseInt(population), counter));
                    if(i != 0){
                        rectangle.setFill(Color.YELLOW);
                    }
                    //scaleTransition1.runScaleTransition(rectangleList.get(counter), getBarRatio(Integer.parseInt(population), counter));
                    //scaleTransition1 = new ScaleTransition1(rectangleList.get(counter), getBarRatio(Integer.parseInt(population), counter));
                    scaleTransition1.runScaleTransition(rectangleList.get(counter), getBarRatio(Integer.parseInt(population), counter));
                    try {
                        Thread.sleep(500);
